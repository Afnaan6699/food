              ...
              {activeTab === "live" ? (
                <>
                  ...
                  <svg className="absolute inset-0 w-full h-full z-10" xmlns="http://www.w3.org/2000/svg">
                    <path
                      d="M 120 480 Q 250 350 400 300 T 650 180"
                      stroke="var(--color-primary, rgba(16,185,129,0.8))"
                      strokeWidth="5"
                    ...
                    <path
                      d="M 120 480 Q 250 350 400 300 T 650 180"
                      stroke="var(--color-primary, rgba(16,185,129,0.3))"
                      strokeWidth="16"
                      fill="none"
                  ...
                  {/* Driver in transit */}
                  <div className="absolute z-20 transition-all duration-1000 ease-linear" style={{ left: "380px", top: "305px" }}>
                    <div className="relative">
                      <div className="absolute inset-0 bg-primary rounded-full animate-ping opacity-40 scale-150"></div>
                      <div className="h-12 w-12 rounded-full glass gradient-primary flex items-center justify-center shadow-glow text-white relative z-10 border border-white/20">
                  ...
                  {/* Donor & NGO Markers */}
                  <div className="absolute z-10" style={{ left: "100px", top: "460px" }}>
                    <div className="relative group">
                      <div className="h-10 w-10 rounded-full gradient-warm flex items-center justify-center shadow-elegant text-white border-2 border-background">
                        <Truck className="h-4 w-4" />
                      </div>
                      <div className="absolute top-full mt-2 left-1/2 -translate-x-1/2 whitespace-nowrap glass bg-black/80 text-white px-3 py-1.5 rounded-lg text-xs font-semibold z-30 opacity-0 group-hover:opacity-100 transition-opacity">
                        Saffron Restaurant
                      </div>
                    </div>
                  </div>
                  <div className="absolute z-10" style={{ left: "630px", top: "160px" }}>
                    <div className="relative group">
                      <div className="h-12 w-12 rounded-full bg-foreground flex items-center justify-center shadow-elegant text-background border-4 border-background">
